...
Phd_graph <- ggplot(PhDs_Clean, aes(x=Year))  +
  geom_col(aes(y=Female_education, fill="Female_education")) +
  geom_col(aes(y=Female_Humanities, fill="Female_Humanities")) +
  geom_col(aes(y=Female_physical_sci, fill="Female_physical_sci")) +
  geom_col(aes(y=Female_engineering, fill="Female_engineering")) +
  theme_classic()
