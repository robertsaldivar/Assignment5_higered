...
PhDs_Clean_Percent_ps <- PhDs_Clean %>%
  select(female_Physical_Sci_Percent)

rownames(PhDs_Clean_Percent_ps) <- c("1985", "2000", "2015")

PhDs_Clean_Percent_en <- PhDs_Clean %>%
  select(Female_Engineer_Percent)

rownames(PhDs_Clean_Percent_en) <- c("1985", "2000", "2015")

PhDs_Clean_Percent_ed <- PhDs_Clean %>%
  select(Female_Ed_Percent)

rownames(PhDs_Clean_Percent_ed) <- c("1985", "2000", "2015")

PhDs_Clean_Percent_h <- PhDs_Clean %>%
  select(Female_Humanities_Percent)

rownames(PhDs_Clean_Percent_h) <- c("1985", "2000", "2015")
...
PhDs_Chisq <- chisq.test(PhDs_Clean_Percent)
PhDs_Chisq

PhDs_chisq_ps <- chisq.test(PhDs_Clean_Percent_ps)
PhDs_chisq_ps

PhDs_Chisq_en <- chisq.test(PhDs_Clean_Percent_en)
PhDs_Chisq_en

PhDs_Chisq_ed <- chisq.test(PhDs_Clean_Percent_ed)
PhDs_Chisq_ed

PhDs_Chisq_h <- chisq.test(PhDs_Clean_Percent_h)
PhDs_Chisq_h
...
stargazer(Faculty_salary_lm2, Faculty_salary_lm3, Faculty_salary_lm7, Faculty_salary_lm8, Faculty_salary_lm10, Faculty_salary_lm11,  type = "html")
