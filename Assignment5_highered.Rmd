...
Phd_table <- kable(PhDs_Clean2, col.names = c("Physical Science", "Engineering", "Education", "Humanities and Art"), caption = "PhDs awards to Women by Field, 1985, 2000, and 2015") %>%
...
stargazer(Faculty_salary_lm2, Faculty_salary_lm3, Faculty_salary_lm10, Faculty_salary_lm11, title="title",  type = "html")
